...
export const journalListQuerySchema=paginationQuerySchema.extend({status:z.enum(['draft','posted','reversed']).optional(),from:z.string().date().optional(),to:z.string().date().optional(),search:z.string().trim().max(200).optional()});
